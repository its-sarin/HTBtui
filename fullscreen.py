...
class Header:
    ...
    def __rich__(self) -> Panel:
        ...
        grid.add_row(
            "[purple][b]spellb00k[/b][/purple] - [i]Hack The Box[/i] Module",
            datetime.now().ctime().replace(":", "[blink]:[/]"),
        )
        return Panel(grid, box=box.SIMPLE, style="chartreuse1 on black")
...
layout["box1"].update(Panel(htb.print_profile()))
